...
public class RollingMachineMenu extends AbstractContainerMenu {
    public final RollingMachineBlockEntity blockEntity;
    ...
    public RollingMachineMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 4, 138, 35));
        });
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 27; // Height in pixels of the arrow

        return maxProgress != 0 && progress != 0 ? progress * progressArrowSize / maxProgress : 0;
    }

    // Don't even care to comprehend what's going on down in quickMoveStack
    // Maybe I'll try to figure it out if shift clicking is needed...
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.ROLLING_MACHINE_BLOCK.get());
    }
